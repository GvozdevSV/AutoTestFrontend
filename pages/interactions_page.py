...
class SortablePage(BasePage):
    ...
    @allure.step("получить обьект для сортировки")
    def get_sortable_item(self, elements):
        item_list = self.elements_are_visible(elements)
        return [item.text for item in item_list]

    @allure.step("изменить список")
    ...
    @allure.step("изменить порядок в таблице")
...
class SelectablePage(BasePage):
    ...
    @allure.step("кликнуть на выбранный элемент")
    def click_selectable_item(self, elements):
        item_list = self.elements_are_visible(elements)
        random.sample(item_list, k=1)[0].click()

    @allure.step("выбрать объект из списка")
    ...
    @allure.step("выбрать объект из таблицы")
...
class ResizablePage(BasePage):
    ...
    @allure.step("проверить изменение размера ограниченного окна ")
    ...
    @allure.step("проверить максимальный и минимальный размер ограниченного окна")
    ...
    @allure.step("проверить изменение размера неограниченного окна")
...
class DroppablePage(BasePage):
    ...
    @allure.step("проверка простого перетаскивания")
    ...
    @allure.step("проверка разрешенного перетаскивания")
    ...
    @allure.step("проверка перетаскивания на вложенное поле")
    ...
    @allure.step("проверка возвращения объектов при перетаскивании")
